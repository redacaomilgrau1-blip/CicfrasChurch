 ...
 * @typedef {import('react').HTMLAttributes<HTMLSpanElement>} DropdownMenuShortcutProps
 */
...
const DropdownMenuCheckboxItem = React.forwardRef(
  /**
   * @param {DropdownMenuCheckboxItemProps} props
   * @param {import('react').ForwardedRef<HTMLDivElement>} ref
   */
...
const DropdownMenuRadioItem = React.forwardRef(
  /**
   * @param {DropdownMenuRadioItemProps} props
   * @param {import('react').ForwardedRef<HTMLDivElement>} ref
   */
